      ...
      <div className=" w-screen h-[100vh]">
        <div className="relative flex h-full w-full flex-col items-center justify-center overflow-hidden  ">
          ...
          <div className="h-full w-full  flex justify-center items-center flex-col">
            <Fade direction="down" duration={800} triggerOnce className="h-fit flex justify-center w-full">

            <img
              src="/techKurukshetra/techKurukshetraWritten.png"
              alt=""
              className="h-auto md:w-[80%] w-[95%]"
              />
              </Fade>
              <Fade direction="up" triggerOnce className="h-auto w-auto flex justify-center items-center flex-col">
                <HomeDevfoliobutton />
                <HomeDiscordButton/>
              </Fade>
          </div>
